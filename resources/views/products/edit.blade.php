                    ...
                    <form action="{{ route('products.update', ['id' => $products->id]) }}" method="post"
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control" type="text" name="productname" id=""
                                placeholder="Product Name" value="{{ old('productname', $products->name) }}" required>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea class="form-control" name="description" id="" cols="10" rows="4"
                                placeholder="Product Description" required>{{ old('description', $products->description) }}</textarea>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control" type="file" name="image"
                                value="{{ old('image', $products->image) }}" id="">
                            @if ($errors->has('image'))
